...
CSV_FORMAT = [("Department", lambda s: s.department),
              ...
              ("July 2015 to June 2016: digital volume",
              ...
              ("October 2015 to September 2016: volume",
               lambda s: as_number(getattr(s, "2016_q4_vol"))),
              ("October 2015 to September 2016: digital volume",
               lambda s: as_number(getattr(s, "2016_q4_digital_vol"))),
              ("October 2015 to September 2016: cost per transaction (£)",
               lambda s: as_number(getattr(s, "2016_q4_cpt"))),
              ("January 2016 to December 2016: volume",
               lambda s: as_number(getattr(s, "2017_q1_vol"))),
              ("January 2016 to December 2016: digital volume",
               lambda s: as_number(getattr(s, "2017_q1_digital_vol"))),
              ("January 2016 to December 2016: cost per transaction (£)",
               lambda s: as_number(getattr(s, "2017_q1_cpt"))),
              ("April 2016 to March 2017: volume",
               lambda s: as_number(getattr(s, "2017_q2_vol"))),
              ("April 2016 to March 2017: digital volume",
               lambda s: as_number(getattr(s, "2017_q2_digital_vol"))),
              ("April 2016 to March 2017: cost per transaction (£)",
               lambda s: as_number(getattr(s, "2017_q2_cpt"))),
              ("April 2017 to March 2018: volume",
               lambda s: as_number(getattr(s, "2017_q3_vol"))),
              ("April 2017 to March 2018: digital volume",
               lambda s: as_number(getattr(s, "2017_q3_digital_vol"))),
              ("April 2017 to March 2018: cost per transaction (£)",
